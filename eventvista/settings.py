"""
Django settings for eventvista project.
...
SECRET_KEY = 'django-insecure-tklfy@otnzwq_9jlbrb*znvyem8zq(2-x1rqw)pr1qhzz9#o*e'
...
WSGI_APPLICATION = 'eventvista.wsgi.application'
